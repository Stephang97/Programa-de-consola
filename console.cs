...
namespace AplicacionDeConsola
{
    class Suma
    {
        static void Main(string[] args)
        {
            ...
            numero1 = Convert.ToInt32(Console.ReadLine());  // 'Convert.ToInt32' convierte un dato de tipo string en un dato tipo number 
            ...
            Console.WriteLine("Ingrese el tercer número y presione enter");  //  ingresamos el tercer numero
            ...
            Console.ReadKey();  // 'ReadKey toma la tecla preionada que en este caso seria enter y termina el programa'
        }
    }
}
